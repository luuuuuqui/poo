...
class Cliente:
    def __init__(self, id: int, nome: str, email: str, fone: str, senha: str, nascimento: dt):
        ...
        if not isinstance(nascimento, dt):
            raise ValueError("not isinstance(nascimento, dt)")
    ...
    def from_json(dic) -> object:
        ...
        return Cliente(dic["id"], dic["nome"], dic["email"], dic["fone"], dic["senha"], nasc)
